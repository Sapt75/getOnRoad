...
//   console.log(getcardata);
  ...
  const GetData = async(e) =>{
    ...
    const res = await fetch("/carsdata",{
        method:"GET",
        headers:{
                                ...
                                <div className="row g-0 bg-white imgdetailbox px-2">
                                    ...
                                    <div className="col-lg-7 align-self-center col-6">
                                        ...
                                        <div className="getonroadpricebtn display-none-phone">
                                            ...
                                            <NavLink target="_blank" to={`/car-variant-test/${element._id}`}><button className='btn btn-success'>Details</button></NavLink>
                                        </div>
                                        </div>
                                    </div>
                                </div>
